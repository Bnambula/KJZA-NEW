...
function initStaffPortal() {
  ...
  document.getElementById('sp-welcome-sub').textContent = u.title + ' · ' + u.dept + ' — Kujaza Fresh Staff Portal';
...
function renderPayslips() {
  ...
  el.innerHTML = slips.map(s => `
    <div class="payslip-card">
      <div class="ps-header">
        <div>
          <div class="ps-company">Kujaza Fresh Ltd</div>
      ...
      <div class="ps-footer">Paid via bank transfer · ${s.month} · Kujaza Fresh Ltd, Kampala</div>
    </div>`).join('');
}
