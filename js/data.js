...
const KF = {
  ...
  data: {
    ...
    feedback: [
      ...
      { id:5, name:'Peter Ssenyonga',email:'peter@email.com',  rating:5, msg:'I supply a restaurant and Kujaza Freshi has been incredibly reliable for our weekly orders.', date:'2026-03-16', status:'Pending', featured:false },
    ],
    notices: [
    ...
    vouchers: [
      { id:1, code:'FRESHI10',   desc:'10% off your first order',       type:'percent', value:10,    minOrder:20000, uses:0,   maxUses:500,  active:true,  expiry:'2026-06-30' },
