// ===== KUJAZA FRESHI — FINANCE, HR & PAYROLL MODULE =====
...
function stmtHeader(title, period) {
  return '<div class="stmt-header">' +
    '<div class="stmt-company">Kujaza Freshii Ltd</div>' +
...
function stmtFooter() {
  ...
  return '<div class="stmt-footer">' +
    '<div>Prepared by: Finance Department · Kujaza Freshii Ltd</div>' +
